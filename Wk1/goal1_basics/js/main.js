 ...
 ********************************************/
	...
	console.log("The weather is", weather + " and Bob is", bobsMood + ".");
 ...
 ********************************************/
	...
	if (weather === "sunny") {
		if (waves == 10) {
			bobsMood = "pumped";
		} else if ((weather === "sunny") && ((waves >= 5) && (waves <= 9))) {
			bobsMood = "mellow";
		} else {
			bobsMood = "bummed";
		}
	...
	console.log("The weather is", weather + ", waves are", waves + " and Bob is", bobsMood + ".");
